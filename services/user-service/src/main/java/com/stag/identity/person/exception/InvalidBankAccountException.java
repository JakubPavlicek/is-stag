...
///
/// Thrown when bank account validation fails due to invalid field combinations or missing required data (e.g., suffix without bank code, prefix without a suffix).
///
