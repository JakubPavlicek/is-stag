...
public class DomainController implements DomainsApi {
    ...
    @Override
    public ResponseEntity<@NonNull DomainValueListResponse> getDomainValues(String domain, String acceptLanguage) {
    ...
    @Override
    public ResponseEntity<@NonNull DomainListResponse> getDomains() {
